...
const miembros = [
  { rol: t('equipo.piloto'), nombre: 'Alan Ampudia', detail: t('equipo.piloto_detail'), bio: 'Campeón Mundial SCORE Trophy Truck 2024. El primer ensenadense en lograr el título absoluto. Lleva las riendas del Ford Raptor #1.', code: 'P.001', img: '/images/01-alan-portrait.webp' },
  { rol: t('equipo.team_principal'), nombre: 'Rodrigo Ampudia Sr.', detail: t('equipo.team_principal_detail'), bio: 'El líder absoluto y el cerebro detrás de la escudería. Su filosofía prioriza la fiabilidad técnica por encima de todo: después de cada carrera, desarman el Trophy Truck por completo, revisan cada componente y lo reensamblan con tornillos completamente nuevos.', code: 'T.002', img: '/images/team/papa-alan.webp' },
  { rol: t('equipo.copiloto'), nombre: 'Kyle "El K"', detail: t('equipo.copiloto_detail'), bio: 'El estratega a bordo del Trophy Truck #1. Su precisión implacable al cantar las notas de navegación a velocidades extremas ha sido un pilar fundamental para las victorias consecutivas del equipo en la temporada 2025. Detrás de cada rey del Off-Road hay un navegante que nunca pierde el rumbo.', code: 'C.003', img: '/images/copiloto/copiloto.webp' },
  { rol: t('equipo.mecanico_lider'), nombre: '"El Pollo"', detail: t('equipo.mecanico_lider_detail'), bio: 'Uno de los mecánicos de mayor confianza mencionados recurrentemente por Alan. Su capacidad para trabajar bajo presión y resolver problemas mecánicos complejos en minutos marca la diferencia entre ganar y abandonar.', code: 'M.005', img: '/images/team/accion.webp' },
  { rol: t('equipo.mecanico'), nombre: 'Gael', detail: t('equipo.mecanico_detail'), bio: 'Junto a "El Pollo", forma el dúo de mecánicos de élite que mantiene el Trophy Truck #1 en condiciones de victoria. Pieza clave en las reparaciones de emergencia que han salvado carreras.', code: 'M.006', img: '/images/team/06-pit-stop.webp' },
];
